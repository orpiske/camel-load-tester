...
$(CAMEL_VERSIONS): dest-dir
	...
	$(foreach host,$(TEST_HOSTS),scp camel-load-testers/camel-load-tester-consumers/camel-load-tester-consumer-kafka/target/camel-load-tester-consumer-$@*.jar $(host):$(TESTER_DIR); )
